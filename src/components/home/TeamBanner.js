...
const TeamBanner = () => {
    ...
    return (
        <div id="teamBanner" className="relative py-20 overflow-hidden bg-white">
            ...
            {/* Decorative elements */}
            <svg className="z-0 absolute top-0 right-0 -mt-20 -mr-20 text-blue-100 w-64 h-64 rotate-45 transform" fill="currentColor" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
                <polygon points="50,0 100,0 50,100 0,100" />
            </svg>

            <svg className="z-0 absolute bottom-0 left-0 -mb-20 -ml-20 text-blue-100 w-64 h-64 rotate-45 transform" fill="currentColor" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
                <polygon points="50,0 100,0 50,100 0,100" />
            </svg>
        </div>
